...
export function AppShell() {
  return (
    <div className="min-h-screen flex items-start justify-center p-4 md:p-8">
      <div className="w-full max-w-[1100px] flex flex-col rounded-2xl border border-border-soft bg-surface-1/60 backdrop-blur overflow-hidden shadow-2xl shadow-black/40">
        <Topbar />
